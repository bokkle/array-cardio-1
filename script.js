...
const sortBirthYear = inventors.sort((a, b) => a.year - b.year);
// console.log(sortBirthYear);

// Array.prototype.reduce()
// 4. What is the sum of all of the inventors lives?
...
// console.table(sortLifeSpan.reverse())
...
const sumInstances = () => {
  ...
  return `cars = ${cars}, trucks = ${trucks}, bikes = ${bikes}, walks = ${walks}, vans = ${vans}`;
};
